    ...
    <div className="space-y-6 max-w-3xl mx-auto">
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          Crie novos pedidos de suprimentos para repor o estoque da cantina.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Adicione os produtos e quantidades desejadas para nova compra.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            {items.map((item) => (
              <div
                key={item.id}
                className="flex flex-col sm:flex-row sm:items-end gap-4 animate-in fade-in slide-in-from-bottom-2 duration-300"
              >
